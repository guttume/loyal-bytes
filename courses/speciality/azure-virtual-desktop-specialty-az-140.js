  ...
  idealFor:
    "Candidates for this exam are administrators with subject matter expertise in planning, delivering, and managing virtual desktop experiences and remote apps, for any device, on Azure. Responsibilities for this role include deploying virtual desktop experiences and apps to Azure. Professionals in this role deliver applications on Azure Virtual Desktop and optimize them to run in multi-session virtual environments. To deliver these experiences, they work closely with the Azure administrators and architects, along with Microsoft 365 Administrators. Candidates for this exam should have experience in Azure technologies, including virtualization, networking, identity, storage, backups, resilience, and disaster recovery. They should understand on-premises virtual desktop infrastructure technologies as they relate to migrating to Azure Virtual Desktop. These professionals use the Azure portal and Azure Resource Manager templates to accomplish many tasks. This role may use powershell and Azure Command-Line Interface (CLI) for more efficient automation. Candidates for this exam must have expert Azure administration skills.",
  ...
  modules: [
    {
      title:
        "Module 1: PLAN AN AZURE VIRTUAL DESKTOP ARCHITECTURE (10-15%)",
      submodules: [
        {
          heading: "DESIGN THE AZURE VIRTUAL DESKTOP ARCHITECTURE",
          contents: [
        ...
        {
          heading: "DESIGN FOR USER IDENTITIES AND PROFILES",
          contents: [
    ...
    {
      title:
        "Module 2: IMPLEMENT AN AZURE VIRTUAL DESKTOP INFRASTRUCTURE (25-30%)",
      submodules: [
        {
          heading: "IMPLEMENT AND MANAGE NETWORKING FOR AZURE VIRTUAL DESKTOP",
          contents: [
        ...
        {
          heading: "IMPLEMENT AND MANAGE STORAGE FOR AZURE VIRTUAL DESKTOP",
          contents: [
        ...
        {
          heading: "CREATE AND CONFIGURE HOST POOLS AND SESSION HOSTS",
          contents: [
        ...
        {
          heading: "CREATE AND MANAGE SESSION HOST IMAGES",
          contents: [
            "Create a gold image",
    ...
    {
      title:
        "Module 3: MANAGE ACCESS AND SECURITY (10-15%)",
      submodules: [
        {
    ...
    {
      title:
        "Module 4: MANAGE USER ENVIRONMENTS AND APPS (20-25%)",
      submodules: [
        {
          heading: "IMPLEMENT AND MANAGE FSLOGIX",
          contents: [
            "Plan for fslogix",
        ...
        {
          heading: "CONFIGURE USER EXPERIENCE SETTINGS",
          contents: [
        ...
        {
          heading: "INSTALL AND CONFIGURE APPS ON A SESSION HOST",
          contents: [
    ...
    {
      title:
      "Module 5: MONITOR AND MAINTAIN AN AZURE VIRTUAL DESKTOP INFRASTRUCTURE (20- 25%)",
    submodules: [
      {
        heading: "PLAN AND IMPLEMENT BUSINESS CONTINUITY AND DISASTER RECOVERY",
        contents: [
      ...
      {
        heading: "AUTOMATE AZURE VIRTUAL DESKTOP MANAGEMENT TASKS",
        contents: [
      ...
      {
        heading: "MONITOR AND MANAGE PERFORMANCE AND HEALTH",
        contents: [
