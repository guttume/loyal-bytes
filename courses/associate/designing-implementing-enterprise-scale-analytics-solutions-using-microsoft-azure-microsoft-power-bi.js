export default {
  ...
  modules: [
    {
      title:
        "Module 1: IMPLEMENT AND MANAGE A DATA ANALYTICS ENVIRONMENT (25–30%)",
      submodules: [
        {
    ...
    },
    {
      ...
      submodules: [
        ...
        {
          heading: "INGEST AND TRANSFORM DATA BY USING POWER BI ",
          contents: [
    ...
    },
    {
      ...
      submodules: [
        ...
        {
          heading: "VISUALIZE DATA BY USING POWER BI",
          contents: [
