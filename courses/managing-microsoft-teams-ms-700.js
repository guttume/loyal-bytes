export default {
  title: "Managing Microsoft Teams MS - 700 ",
  subtitle:
  ...
  modules: [
    {
      title:
        "Module 1: PLAN AND CONFIGURE A MICROSOFT TEAMS ENVIRONMENT (35-40%) ",
      submodules: [
        {
          heading: "PLAN AND CONFIGURE NETWORK SETTINGS FOR MICROSOFT TEAMS ",
          contents: [
        ...
        {
          heading: "IDENTIFY LICENSING REQUIREMENTS FOR MICROSOFT TEAMS ",
          contents: [
        ...
        {
          heading:
            "9.1.3	PLAN AND CONFIGURE SECURITY AND COMPLIANCE SETTINGS FOR MICROSOFT TEAMS ",
          contents: [
        ...
        {
          heading: "CONFIGURE AND MANAGE EXTERNAL AND GUEST USERS ",
          contents: [
        ...
        {
          heading: "CONFIGURE AND MANAGE MICROSOFT TEAMS DEVICES ",
          contents: [
    ...
    {
      title: "Module 2: MANAGE CHAT, TEAMS, CHANNELS, AND APPS (25-30%)",
      submodules: [
        {
          heading: "CREATE AND MANAGE TEAMS ",
          contents: [
            "Create teams ",
        ...
        {
          heading: "PLAN AND MANAGE CHANNELS ",
          contents: [
        ...
        {
          heading: "MANAGE CHAT AND COLLABORATION EXPERIENCES ",
          contents: [
        ...
        {
          heading: "MANAGE APPS FOR MICROSOFT TEAMS ",
          contents: [
    ...
    {
      title: "Module 3: MANAGE CALLING AND MEETINGS (15-20%)",
      submodules: [
        {
          heading: "MANAGE MEETING EXPERIENCES ",
          contents: [
        ...
        {
          heading: "MANAGE PHONE SYSTEM FOR MICROSOFT TEAMS ",
          contents: [
    ...
    {
      title:
        "Module 4: MONITOR AND TROUBLESHOOT A MICROSOFT TEAMS ENVIRONMENT (10-15%) ",
      submodules: [
        {
          heading: "MONITOR AND REPORT ON A MICROSOFT TEAMS ENVIRONMENT",
          contents: [
        ...
        {
          heading: "9.4.2	TROUBLESHOOT AUDIO, VIDEO, AND CLIENT ISSUES ",
          contents: [
