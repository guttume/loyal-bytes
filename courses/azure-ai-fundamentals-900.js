export default {
  title: "Azure AI Fundamentals - 900",
  subtitle:
  ...
  courseDetail: {
    ...
    batchInfo: "Weekend batches available",
    level: "100",
    highlights: [
      {
        icon: "user",
  ...
  modules: [
    {
      title:
        "Module 1: DESCRIBE ARTIFICIAL INTELLIGENCE WORKLOADS AND CONSIDERATIONS (20—25%)  ",
      submodules: [
        {
          heading: "IDENTIFY FEATURES OF COMMON AI WORKLOADS",
          contents: [
        ...
        {
          heading: "IDENTIFY GUIDING PRINCIPLES FOR RESPONSIBLE AI",
          contents: [
    ...
    },
    {
      ...
      submodules: [
        {
          heading: "IDENTIFY COMMON MACHINE LEARNING TYPES",
          contents: [
        ...
        {
          heading: "DESCRIBE CORE MACHINE LEARNING CONCEPTS",
          contents: [
    ...
    },
    {
      ...
      submodules: [
        {
          heading: "IDENTIFY COMMON TYPES OF COMPUTER VISION SOLUTION",
          contents: [
    ...
    },
    {
      ...
      submodules: [
        {
          heading: "9.4.1	IDENTIFY FEATURES OF COMMON NLP WORKLOAD SCENARIOS",
          contents: [
        ...
        {
          heading: "9.4.2	IDENTIFY AZURE TOOLS AND SERVICES FOR NLP WORKLOADS",
          contents: [
