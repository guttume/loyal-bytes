export default {
  title: "Dynamics 365 Fundamentals (ERP) - 920",
  subtitle:
  ...
  modules: [
    {
      ...
      submodules: [
        ...
        {
          heading:
            "9.1.2	DESCRIBE WAREHOUSE AND INVENTORY MANAGEMENT CAPABILITIES",
          contents: [
        ...
        {
          heading: "9.1.3	DESCRIBE MANUFACTURING STRATEGIES",
          contents: [
        ...
        {
          heading: "9.1.4	DESCRIBE ENTERPRISE ASSET MANAGEMENT CAPABILITIES",
          contents: [
    ...
    {
      title: "Module 2:	DESCRIBE DYNAMICS FINANCE (20-25%)",
      submodules: [
        {
          heading: "9.2.1	DESCRIBE THE DYNAMICS 365 FINANCE FEATURES",
          contents: [
        ...
        {
          heading: "9.2.2	DESCRIBE GENERAL LEDGERS",
          contents: [
            "describe charts of accounts including main accounts, balance sheets, and income statements",
            "describe financial dimensions and dimensions set concepts",
            "describe periodic financial processes",
          ],
        },
        {
          heading: "9.2.3	DESCRIBE ACCOUNTS PAYABLES AND ACCOUNTS RECEIVABLES",
          contents: [
        ...
        {
          heading: "9.2.4	DESCRIBE RELATED FINANCE COMPONENTS",
          contents: [
    ...
    {
      title: "Module 3: DESCRIBE DYNAMICS 365 COMMERCE (10-15%)",
      submodules: [
        {
          heading: "9.3.1	DESCRIBE DYNAMICS 365 COMMERCE CAPABILITIES",
          contents: [
        ...
        {
          heading: "9.3.2	DESCRIBE DYNAMICS 365 FRAUD PROTECTION",
          contents: [
    ...
    {
      title: "Module 4: DESCRIBE DYNAMICS 365 HUMAN RESOURCES (5-10%)",
      submodules: [
        {
          heading: "9.4.1	DESCRIBE CORE CAPABILITIES",
          contents: [
        ...
        {
          heading: "9.4.2	DESCRIBE PERSONNEL MANAGEMENT CAPABILITIES",
          contents: [
    ...
    {
      title: "Module 5: DESCRIBE PROJECT OPERATIONS (10-15%)",
      submodules: [
        {
          heading: "9.5.1	IDENTIFY PROJECT OPERATIONS CAPABILITIES",
          contents: [
        ...
        {
          heading: "9.5.2	DESCRIBE PROJECT PLANNING AND EXECUTION CAPABILITIES",
          contents: [
    ...
    {
      title: "Module 6: DESCRIBE SHARED FEATURES (10-15%)",
      submodules: [
        {
          heading: "9.6.1	DESCRIBE REPORTING CAPABILITIES",
          contents: [
        ...
        {
          heading: "9.6.2	DESCRIBE INTEGRATION OPTIONS",
          contents: [
