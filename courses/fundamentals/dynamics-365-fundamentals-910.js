export default {
  title: "Dynamics 365 Fundamentals (CRM) - 910",
  subtitle:
  ...
  courseDetail: {
    ...
    description:
      "Whether you are a business stakeholder, functional consultant at the start of your career or a student, this certification is a validation of your broad knowledge of the customer engagement apps in Microsoft Dynamics 365, including marketing capabilities, and the automation of the sales, service and support lifecycles. It is recommended for tech-savvy individuals with some basic knowledge of business functions like marketing, sales, and services.",
  },
  idealFor:
    "This exam covers the customer engagement features and capabilities of Dynamics 365 apps. Candidates of this exam should have a fundamental understanding of customer engagement principles, and business operations, general computer skills",

  learningObjectives:
    "Understand the core capabilities across the Dynamic 365 customer engagement apps. Validate your Dynamics 365 skills. Highlight your understanding of business operations and customer engagement. Demonstrate capability in Dynamics 365 customer engagement capabilities to move to the next level",
  modules: [
    {
      title: "Module 1:	DESCRIBE DYNAMICS 365 MARKETING (15–20%) ",
      submodules: [
        {
          heading: "8.1.1	IDENTIFY DYNAMICS 365 MARKETING CAPABILITIES ",
          contents: [
        ...
        {
          heading: "8.1.2	DESCRIBE RELATED MARKETING APPS",
          contents: [
    ...
    {
      title: "Module 2:	DESCRIBE DYNAMICS 365 SALES (15–20%)",
      submodules: [
        {
          heading: "8.2.1	DESCRIBE THE DYNAMICS 365 SALES LIFECYCLE ",
          contents: [
            ...
            "Describe sales pipeline forecasting sales concepts ",
    ...
    {
      title: "Module 3: DESCRIBE DYNAMICS 365 CUSTOMER SERVICE (15–20%) ",
      submodules: [
        {
          heading: "8.3.1	DESCRIBE DYNAMICS 365 CUSTOMER SERVICE COMPONENTS",
          contents: [
            "Describe Knowledge Management ",
            "Describe the cases lifecycle including service-level agreements",
    ...
    {
      title: "Module 4: DESCRIBE DYNAMICS 365 FIELD SERVICE (15–20%) ",
      submodules: [
        {
          heading: "8.4.1	DESCRIBE THE WORK ORDER LIFECYCLE",
          contents: [
            "Describe the work order lifecycle",
            "Describe capabilities for of the Inspections feature ",
            "Describe customer asset management and preventive maintenance processes ",
          ],
        },
        {
          heading: "8.4.2	DESCRIBE SCHEDULING CAPABILITIES",
          contents: [
            ...
            "Describe how to enable proactive customer asset management by using Connected Field Service ",
          ],
        },
      ],
    },
    {
      title: "Module 5: DESCRIBE SHARED FEATURES (20–25%)",
      submodules: [
        {
          heading: "8.5.1	IDENTIFY COMMON CUSTOMER ENGAGEMENT FEATURES",
          contents: [
        ...
        {
          heading: "8.5.2	DESCRIBE REPORTING CAPABILITIES",
          contents: [
