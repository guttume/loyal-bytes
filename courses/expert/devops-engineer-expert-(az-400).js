export default {
  ...
  courseDetail: {
    ...
    description:
      "Candidates for this exam should have advanced experience and knowledge of IT operations, including networking, virtualization, identity, security, business continuity, disaster recovery, data platforms, and governance. A professional in this role should manage how decisions in each area affect an overall solution. In addition, they should have experience in Azure administration, Azure development, and DevOps processes. Candidates for the DevOps Engineer Expert certification should have subject matter expertise working with people, processes, and technologies to continuously deliver business value. Responsibilities for this role include designing and implementing strategies for collaboration, code, infrastructure, source control, security, compliance, continuous integration, testing, delivery, monitoring, and feedback. A candidate for this certification must be familiar with both Azure administration and development and must be expert in at least one of these areas.",
  },
  idealFor:
  ...
  modules: [
    {
      title:
        "Module 1: DEVELOP AN INSTRUMENTATION STRATEGY (5-10%)",
      submodules: [
        {
        ...
        {
          heading: "9.1.3	INTEGRATE LOGGING AND MONITORING SOLUTIONS",
          contents: [
    ...
    {
      title:
        "Module 2: DEVELOP A SITE RELIABILITY ENGINEERING (SRE) STRATEGY (5-10%)",
      submodules: [
        {
        ...
        {
          heading: "9.2.3	DESIGN AND IMPLEMENT A HEALTH CHECK",
          contents: [
    ...
    {
      title:
        "Module 3: DEVELOP A SECURITY AND COMPLIANCE PLAN (10-15%)",
      submodules: [
        {
    ...
    {
      title:
        "Module 4: MANAGE SOURCE CONTROL (10-15%)",
      submodules: [
        {
    ...
    {
      title:
        "Module 5: FACILITATE COMMUNICATION AND COLLABORATION (10-15%)",
      submodules: [
        {
    ...
    {
      title:
        "Module 6: DEFINE AND IMPLEMENT CONTINUOUS INTEGRATION (20-25%)",
      submodules: [
        {
    ...
    {
      title:
        "Module 7: DEFINE AND IMPLEMENT A CONTINUOUS DELIVERY AND RELEASE MANAGEMENT STRATEGY (10-15%)",  
      submodules: [
        {
