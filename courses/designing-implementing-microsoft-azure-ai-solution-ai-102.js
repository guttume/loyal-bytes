export default {
  ...
  modules: [
    {
      title:
        "Module 1: PLAN AND MANAGE AN AZURE COGNITIVE SERVICES SOLUTION (15-20%)",
      submodules: [
        {
          heading: "SELECT THE APPROPRIATE COGNITIVE SERVICES RESOURCE",
          contents: [
        ...
        {
          heading: "PLAN AND CONFIGURE SECURITY FOR A COGNITIVE SERVICES SOLUTION",
          contents: [
        ...
        {
          heading: "CREATE A COGNITIVE SERVICES RESOURCE",
          contents: [
        ...
        {
          heading: "PLAN AND IMPLEMENT COGNITIVE SERVICES CONTAINERS",
          contents: [
            "Identify when to deploy to a container",
            "Containerize Cognitive Services (including Computer Vision API, Face API, Text Languages, Speech, Form Recognizer)",
    ...
    {
      title:
        "Module 2:  IMPLEMENT COMPUTER VISION SOLUTIONS (20-25%)",
      submodules: [
        {
          heading: "ANALYZE IMAGES BY USING THE COMPUTER VISION API",
          contents: [
        ...
        {
          heading: "EXTRACT FACIAL INFORMATION FROM IMAGES",
          contents: [
        ...
        {
          heading: "IMPLEMENT IMAGE CLASSIFICATION BY USING THE CUSTOM VISION SERVICE",
          contents: [
        ...
        {
          heading: "IMPLEMENT AN OBJECT DETECTION SOLUTION BY USING THE CUSTOM VISION SERVICE",
          contents: [
        ...
        {
          heading: "ANALYZE VIDEO BY USING AZURE VIDEO ANALYZER FOR MEDIA (FORMERLY VIDEO INDEXER)",
          contents: [
            "Process a video",
    ...
    {
      title:
        "Module 3: IMPLEMENT NATURAL LANGUAGE PROCESSING SOLUTIONS (20-25%)",
      submodules: [
        {
          heading: "ANALYZE TEXT BY USING THE TEXT LANGUAGE SERVICE",
          contents: [
        ...
        {                                   
          heading: "MANAGE SPEECH BY USING THE SPEECH SERVICE",
          contents: [
        ...
        {
          heading: "BUILD AN INITIAL LANGUAGE MODEL BY USING LANGUAGE UNDERSTANDING SERVICE (LUIS)",
          contents: [
        ...
        {
          heading: "ITER ATE ON AND OPTIMIZE A LANGUAGE MODEL BY USING LANGUAGE UNDERSTANDING",
          contents: [
        ...
        {
          heading: "MANAGE A LANGUAGE UNDERSTANDING MODEL",
          contents: [
        ...
        {
          heading: "CREATE A QUESTIONS ANSWERING SOLUTION USING THE LANGUAGE SERVICE",
          contents: [
    ...
    {
      title:
        "Module 4: IMPLEMENT KNOWLEDGE MINING SOLUTIONS (15-20%)",
      submodules: [
        {
          heading: "IMPLEMENT A COGNITIVE SEARCH SOLUTION",
          contents: [
            "Create data sources", 
            "Define an index", 
        ...
        {
          heading: "IMPLEMENT AN ENRICHMENT PIPELINE",
          contents: [
        ...
        {
          heading: "IMPLEMENT A KNOWLEDGE STORE",
          contents: [
        ...
        {
          heading: "MANAGE A COGNITIVE SEARCH SOLUTION",
          contents: [
    ...
    {
      title:
        "Module 5: IMPLEMENT CONVERSATIONAL AI SOLUTIONS (15-20%)",
      submodules: [
        {
          heading: "DESIGN AND IMPLEMENT CONVERSATION FLOW",
          contents: [
        ...
        {
          heading: "CREATE A BOT BY USING THE BOT FRAMEWORK SDK",
          contents: [
        ...
        {
          heading: "CREATE A BOT BY USING THE BOT FRAMEWORK COMPOSER",
          contents: [
            "Implement dialogs", 
            "Maintain state",
        ...
        {
          heading: "INTEGRATE COGNITIVE SERVICES INTO A BOT",
          contents: [
