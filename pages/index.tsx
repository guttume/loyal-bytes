...
export default function Index() {
    ...
    return (
        <div>
            <Head>
                <title>Best Cloud Certification Course in Mumbai | Learning.loyalbytes.com</title>
                <meta name="description" content="Visit us on Learning.loyalbytes.com to get the best cloud certification course in Mumbai. Enroll Yourself to become a cloud professional." />
            </Head>
            <div>
                <HeroBanner/>
            </div>
            ...
            <Section>
                ...
                <div className="gap-16 space-y-8 lg:grid-cols-3 md:space-y-0 md:grid md:grid-cols-2">
                    ...
                    >
                        Increase your productivity with cutting-edge Office applications, thoughtful cloud services, and
                        top-notch security.
                    </PopularCourseItem>
                    <PopularCourseItem
            ...
            <Section>
                ...
                <div className="mt-16 lg:relative lg:h-96">
                    ...
                    <div
                        className="lg:absolute lg:w-80 xl:w-[400px] 2xl:w-[500px] lg:right-0 lg:mt-8 lg:mr-4 xl:mr-8 2xl:mr-40 z-10">
                        <img src={images.corporateTrainings} title="Corporate Trainings" alt="corporate trainings"/>
                    </div>
                    <div
                        className="lg:border lg:absolute lg:w-full lg:px-4 2xl:pl-24 lg:py-16 lg:rounded-lg bg-gradient-to-r from-teal-50 via-yellow-50 to-red-50">
                        <div className="lg:w-[600px] p-4">
                            ...
                            <div className="flex justify-center my-4 lg:block">
                                <a href="/corporate-training.html" title="Corporate Training" className="btn btn-black">Know
                                    more</a>
                            </div>
                        </div>
                    </div>
