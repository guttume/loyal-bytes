  ...
  return (
    <>
      <section className="relative">
        ...
        <div className="px-12">
          <h1 className="text-5xl font-bold text-darkerText text-center mt-16 w-full max-w-6xl mx-auto">
          ...
          <div className="flex items-center space-x-4 mt-16">
            ...
            <div className="w-2/8 flex-1 space-y-4">
