...
export const testimonials = [
  {
    name: "Mr. Jenish Doshi",
    company: "Colgate Palmolive",
    image: images.testimonials.brands.colgate,
    designation: "Senior Cloud Infra Engineer",
    body: [
  ...
  },
  {
    ...
    image: images.testimonials.brands.capgemini,
  ...
  {
    name: "Mr. Shashnak Jagadale",
    company: "Johnson Controls International",
    image: images.testimonials.brands.johnson,
    designation: "System Security administrator",
    body: [
  ...
  },
  {
    ...
    image: "",
    designation: "Sr. Technical Specialist",
    body: [
      "Loyal Bytes is a one stop shop for most of the Microsoft technologies. Ronak is an exceptional individual with in and out knowledge of the Microsoft workspace. The training that I received laid a foundation to what i am today as an individual. I have been in touch with Ronak for over 5 years and he doesn't fail to impress. Not only did i learn under him but also had a bunch of my colleagues, peers and friends join him and all have been very happy and content with the knowledge he had to part.",
      "I would recommend him with eyes closed if you intend to make a career in Microsoft technologies with being upto date in Market standards.",
      "Kudos!!! Loyal Bytes",
    ],
  },
];
